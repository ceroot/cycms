<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\www\think5\code\application\admin\view\main\index.html";i:1461120486;s:67:"D:\www\think5\public/../code/application/admin\view\mould\base.html";i:1461037929;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
  ...
  <aside class="main-sidebar">
    <section class="sidebar"> 
      <ul>
        <li>
          <dl>
            <dt><a href="<?php echo U('index'); ?>" title="index3"><i class="fa fa-home"></i> <span>首页</span></a></dt>
          </dl>
        </li>
        <li>
          <dl>
            <dt><a href="<?php echo U('index2'); ?>" title="index3"><i class="fa fa-circle-o"></i> <span>index2</span></a></dt>
          </dl>
        </li>
        <li>
          <dl>
            <dt><a href="<?php echo U('index3'); ?>" title="index3"><i class="fa fa-circle-o"></i> <span>index3</span></a></dt>
          </dl>
        </li>
        <li class="active">
          <dl>
            ...
            <dd style="display: block;">
              <a class="active" href="<?php echo U('index3'); ?>" title="产品"><i class="fa fa-circle-o text-yellow"></i> 产品</a>
              <a href="<?php echo U('index3'); ?>" title="产品1"><i class="fa fa-circle-o text-yellow"></i> 产品1</a>
              <a href="<?php echo U('index3'); ?>" title="产品2"><i class="fa fa-circle-o text-yellow"></i> 产品2</a>
              <a href="<?php echo U('index3'); ?>" title="产品3"><i class="fa fa-circle-o text-yellow"></i> 产品3</a>
              <a href="<?php echo U('index3'); ?>" title="产品4"><i class="fa fa-circle-o text-yellow"></i> 产品4</a>
            </dd>
          </dl>
        </li>
        <li>
          <dl>
            <dt><a href="" title=""><i class="fa fa-product-hunt"></i> <span>产品产品</span><em class="fa fa-angle-left pull-right"></em></a></dt>
            <dd>
              <a href="<?php echo U('index3'); ?>" title="产品"><i class="fa fa-circle-o text-yellow"></i> 产品产品</a>
              <a href="<?php echo U('index3'); ?>" title="产品1"><i class="fa fa-circle-o text-yellow"></i> 产品产品1</a>
              <a href="<?php echo U('index3'); ?>" title="产品2"><i class="fa fa-circle-o text-yellow"></i> 产品产品2</a>
              <a href="<?php echo U('index3'); ?>" title="产品3"><i class="fa fa-circle-o text-yellow"></i> 产品产品3</a>
              <a href="<?php echo U('index3'); ?>" title="产品4"><i class="fa fa-circle-o text-yellow"></i> 产品产品4</a>
            </dd>
          </dl>
        </li>
        <li>
          <dl>
            <dt><a href="" title=""><i class="fa fa-product-hunt"></i> <span>产品</span><em class="fa fa-angle-left pull-right"></em></a></dt>
            <dd>
              <a href="<?php echo U('index3'); ?>" title="产品"><i class="fa fa-circle-o text-yellow"></i> 产品</a>
              <a href="<?php echo U('index3'); ?>" title="产品1"><i class="fa fa-circle-o text-yellow"></i> 产品1</a>
              <a href="<?php echo U('index3'); ?>" title="产品2"><i class="fa fa-circle-o text-yellow"></i> 产品2</a>
              <a href="<?php echo U('index3'); ?>" title="产品3"><i class="fa fa-circle-o text-yellow"></i> 产品3</a>
              <a href="<?php echo U('index3'); ?>" title="产品4"><i class="fa fa-circle-o text-yellow"></i> 产品4</a>
        ...
        <li>
          <dl>
            <dt><a href="" title=""><i class="fa fa-product-hunt"></i> <span>产品end</span><em class="fa fa-angle-left pull-right"></em></a></dt>
            <dd>
              <a href="<?php echo U('index3'); ?>" title="产品"><i class="fa fa-circle-o text-yellow"></i> 产品</a>
              <a href="<?php echo U('index3'); ?>" title="产品1"><i class="fa fa-circle-o text-yellow"></i> 产品1</a>
              <a href="<?php echo U('index3'); ?>" title="产品2"><i class="fa fa-circle-o text-yellow"></i> 产品2</a>
              <a href="<?php echo U('index3'); ?>" title="产品3"><i class="fa fa-circle-o text-yellow"></i> 产品3</a>
              <a href="<?php echo U('index3'); ?>" title="产品4"><i class="fa fa-circle-o text-yellow"></i> 产品4end</a>
            </dd>
          </dl>
        </li>
      </ul>
