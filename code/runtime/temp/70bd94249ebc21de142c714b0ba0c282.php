<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\www\think5\public/../code/application/admin\view\console\index3.html";i:1461569559;s:67:"D:\www\think5\public/../code/application/admin\view\mould\base.html";i:1461652854;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
              ...
              <?php if(!empty($menu['items'])): ?>
                <dd class="animated fadeIn">
                  <?php if(is_array($menu['items'])): $i = 0; $__LIST__ = $menu['items'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$items): $mod = ($i % 2 );++$i;?>
                    <a href="<?php echo $items['name']; ?>" title="<?php echo $items['title']; ?>"><i class="fa fa-circle-o"></i> <?php echo $items['title']; ?></a>
